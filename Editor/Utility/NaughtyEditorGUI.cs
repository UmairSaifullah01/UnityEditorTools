...
namespace THEBADDEST.EditorTools
{
    public static class NaughtyEditorGUI
    {
        ...
        public static void Button(UnityEngine.Object target, MethodInfo methodInfo)
        {
            ...
            {
                THEBADDEST.ButtonAttribute buttonAttribute = (THEBADDEST.ButtonAttribute)methodInfo.GetCustomAttributes(typeof(THEBADDEST.ButtonAttribute), true)[0];
            ...
            {
                string warning = typeof(THEBADDEST.ButtonAttribute).Name + " works only on methods with no parameters";
